 ...
 */
public class GastosPersonal extends javax.swing.JPanel {

    /**
     * Creates new form GastosPersonal
     */
    public GastosPersonal() {
        initComponents();
    }
     private PrincipalEmpresa b;
     final double SSA = 435.2;
     
     public void setPrincipal(PrincipalEmpresa a){
        this.b=a;
    }
    
     public void desglosarCalculos(){
            ...
            jTextField3.setText(String.valueOf(trabajadores*SSA));
            jTextField1.setText(String.valueOf(IRPFTotal));
            }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SS a cargo de la empresa");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Total gasto salarios");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Hacienda pública IRPF Trabajadores");
