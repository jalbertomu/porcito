...
public class PrincipalTrabajador extends javax.swing.JFrame {
    ...
    private CalculoIRP CI1;
     private AñadirTrabajador AT1;
     private JPanel current;
     private ModificarTrabajador MT1;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Trabajador", "Empresa" }));
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Contrato_22.jpg"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/añadir.jpg"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/IRPF.jpg"))); // NOI18N
        jButton6.setText("IRPF");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if(jComboBox1.getSelectedItem().toString().equals("Trabajador")){
            this.setVisible(true);
        }else{
            this.setVisible(false);
            PrincipalEmpresa PT1 = new PrincipalEmpresa();
            PT1.setVisible(true);
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
         CI1 = new CalculoIRP();
        CI1.setPrincipal(this);
        current = (JPanel) this.getContentPane();
        this.setContentPane(CI1);
        this.validate();
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TrabajadoresSubFrame TSP1 = new  TrabajadoresSubFrame();
        TSP1.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        AT1 = new AñadirTrabajador();
        AT1.setPrincipal(this);
        current = (JPanel) this.getContentPane();
        this.setContentPane(AT1);
        this.validate();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        MT1 = new ModificarTrabajador();
        MT1.setPrincipal(this);
        current = (JPanel) this.getContentPane();
        this.setContentPane(MT1);
        this.validate();
